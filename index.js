...
{
  img: "https://img.gkbcdn.com/p/2022-05-30/tronsmart-element-groove-bluetooth-speaker-black-bbd0c8-1653893706349._w280_p1_.jpg",
  offer: "10% off",
  Price: "Rs" + 2656.28,
...
{
  img: "https://img.gkbcdn.com/p/2021-03-30/xiaomi-mi-band-6-smart-bracelet-1-56-inch-screen-black-1617074128547._w280_p1_.jpg",
  offer: "30% off",
  Price: "Rs" + 1852038,
...
let display1 = (data1) => {
  data1.forEach(function (el) {
    ...
    img.setAttribute("class", "imagepro")
    img.src = el.img
...
let data3 = [
  {
    ...
    img: "https://img.gkbcdn.com/p/2022-05-25/Hawkeye-Firefly-X-4K-60fps-170-Degree-Wide-Angle-501280-0._w280_p1_.jpg",
    Price: "Rs" + 1852038,
  ...
  },
  {
    ...
    img: "https://img.gkbcdn.com/p/2022-05-17/Mini-Camera-Full-HD-1080P-Camcorder-500596-0._w280_p1_.jpg",
    Price: "Rs" + 18538,
    detail: "Hawkeve firefly X?$K 170degree Wide angle wifi gryo camera"
  ...
  },
  {
    ...
    img: "https://img.gkbcdn.com/p/2022-05-09/ANBERNIC-RG503-Portable-Game-Console-16-64GB-Black-500314-0._w280_p1_.jpg",
    Price: "Rs" + 1852038,
    detail: "Hawkeve firefly X?$K 170degree Wide angle wifi gryo camera"
  ...
  },
  {
    ...
    img: "https://img.gkbcdn.com/p/2022-04-07/909cca47ceb64f20b40bf8c04f5b78de-499246-0._w280_p1_.jpg",
    Price: "Rs" + 1852038,
    detail: "Hawkeve firefly X?$K 170degree Wide angle wifi gryo camera"
  ...
  },
  {
    ...
    img: "https://img.gkbcdn.com/p/2022-05-25/Haylou-RS3-LS04-Smartwatch-1-2-Inch-AMOLED-HD-Display-501268-0._w280_p1_.jpg",
    Price: "Rs" + 1852038,
    detail: "Hawkeve firefly X?$K 170degree Wide angle wifi gryo camera"
  ...
  },
  {
    ...
    img: "https://img.gkbcdn.com/p/2022-05-25/Hawkeye-4K-Split-V4-Recording-Low-latency-FPV-Camera-with-Gyroflow-501277-0._w280_p1_.jpg",
    Price: "Rs" + 18538,
    detail: "Hawkeve firefly X?$K 170degree Wide angle wifi gryo camera"
...
var data4 = [
  {
    ...
    off: 30 + "%off",
    dis: "Tronsmart Element Mega SoundPulse™ Bluetooth 5.0 Speaker",
    star: "🌟🌟🌟🌟🌟",
    price: "₹152920"
    ...
    off: 20 + "%off",
    dis: "Lenovo thinkplus LP3 ANC Bluetooth 5.2 TWS Earphones, Active Noise",
    star: "🌟🌟🌟🌟🌟",
    price: "₹2890.0"
    ...
    off: 20 + "%off",
    dis: "Tronsmart Force SoundPulse™ 40W Bluetooth 5.0 Speaker IPX7 Water",
    star: "🌟🌟🌟🌟🌟",
    price: "₹4589.22",
  },
  {
    ...
    off: 30 + "%off",
    dis: "ZLL SG106 Wifi FPV RC Drone with 1080P HD Camera Optical Flow",
    star: "🌟🌟🌟🌟🌟",
    price: "₹4025.53",
  ...
  },
  {
    ...
    off: 30 + "%off",
    dis: "Mifo O7 Bluetooth 5.0 Qualcomm QCC3020 TWS Earphones Carbon",
    star: "🌟🌟🌟🌟🌟",
    price: "₹1025.53",
...
let display4 = (data) => {
  data.forEach(function (el) {
    ...
    var p = document.createElement("p")
    p.innerText = el.price
    p.setAttribute("class", "priced")

    var star = document.createElement("p")
    star.innerText = el.star
    star.setAttribute("class", "star")

    div.append(img, h5, h4, star, p)
...
let data5=[ {
  ...
  off: 20 + "%off",
  dis: "JIMMY PowerWash HW8 Pro Cordless Wet Dry Smart quality",
  price: "₹10254.53",
...
},
{
  ...
  off: 30 + "%off",
  dis: "JIMMY PowerWash HW8 Cordless Wet Dry Smart quality",
  price: "₹34025.53",
...
},
{
  ...
  off: 30 + "%off",
  dis: "JIMMY JV35 Handheld Anti-mite Vacuum Cleaner High",
...
},
{
  ...
  off: 30 + "%off",
  dis: "JIMMY H9 Pro Flexible Smart Handheld Cordless Vacuum",
  price: "₹9025.53",
...
let data6=[ {
  ...
  off: 20 + "%off",
  dis: "ELEGLIDE M1 PLUS Electric Mountain Bike flowless",
  price: "₹10254.53",
...
},
{
  ...
  off: 30 + "%off",
  dis: "JIMMY PowerWash HW8 Cordless Wet Dry Smart",
  price: "₹34025.53",
...
let data7=[
{
  ...
  off: 20 + "%off",
  dis: "Tronsmart Element Mega Pro 60W Bluetooth 5.0 Speaker",
  price: "₹10254.53",
...
},
{
  ...
  off: 30 + "%off",
  dis: "Tronsmart Splash 1 LED 15W Bluetooth Speaker IPX7",
  price: "₹34025.53",
...
},
{
  ...
  off: 30 + "%off",
  dis: "Tronsmart Apollo Q10 ANC Active Noise Cancelling good ",
...
},
{
  ...
  off: 30 + "%off",
  dis: "Tronsmart T6 Plus Upgraded Edition Bluetooth 5.0 40W sound ",
  price: "₹9025.53",
